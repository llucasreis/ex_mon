...
config :ex_mon, ExMonWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "cpJSuqkEB0HfuFsldPbPmqxZT96v9lpBjvs5aWUVsKdxtzBBIbjMTtsIvx03cE+o",
  render_errors: [view: ExMonWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: ExMon.PubSub,
  live_view: [signing_salt: "7AbK/byc"]
...
config :ex_mon, ExMonWeb.Auth.Guardian,
  issuer: "ex_mon",
  secret_key: "FmZraitqbdbT79Aw/yPLpMay5uwVbTChcerzr36U+ioeswHifNqKpRqE2/TpSaaq"
